# Hi there 👋 I am Nikita Bhargava

I am a Senior Data Engineer & Analytics professional with 4+ years of experience architecting scalable data systems, high-performance pipelines, and enterprise-grade data infrastructures. Currently at Google Operations Center, I specialize in bridging the gap between raw, complex datasets and strategic business intelligence.

My approach combines a strong mathematical foundation—holding an M.Sc. in Mathematics from Banaras Hindu University—with specialized Data Engineering training from IIIT Bangalore. This enables me to write complex GoogleSQL logic, optimize ETL/ELT pipelines, and solve intricate system bottlenecks with algorithmic rigor.

### Core Technical Expertise:

🔷 **Data Engineering & Architecture:** ETL/ELT Pipeline Automation, Schema Modeling, GoogleSQL, T-SQL, SSIS, Metadata Management, Hive, Hadoop.

🔷 **Generative AI & LLM Engineering:** RAG Architecture, LangChain, LlamaIndex, Prompt Engineering.

🔷 **Analytics & Data Science:** Applied Statistics, Exploratory Data Analysis (EDA), Machine Learning, Tableau, Power BI, SSRS.
...
📬 Connect with me: nikitabhar28@gmail.com
